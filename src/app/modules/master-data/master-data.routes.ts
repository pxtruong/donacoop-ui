...
export const MasterDataRoutes: Routes = [
  {
    path: ROUTE_CONSTANTS.PAGE.MASTER_DATA.PATH,
    loadComponent: () =>
    ...
    children: [
      {
        path: ROUTE_CONSTANTS.PAGE.MASTER_DATA.CHILDREN.COMPANY.PATH,
        component: CompanyComponent,
      },
      {
        path: ROUTE_CONSTANTS.PAGE.MASTER_DATA.CHILDREN.USER.PATH,
      ...
      {
        path: ROUTE_CONSTANTS.PAGE.MASTER_DATA.CHILDREN.WAREHOUSES.PATH,
        component: WarehouseComponent,
        resolve: [StoneTypeResolver],
      },
      {
        path: ROUTE_CONSTANTS.PAGE.MASTER_DATA.CHILDREN.STONE_TYPE.PATH,
        component: StoneTypeComponent,
      },
      {
        path: ROUTE_CONSTANTS.PAGE.MASTER_DATA.CHILDREN.POSITION.PATH,
        component: PositionComponent,
      },
      {
        path: '',
        redirectTo: ROUTE_CONSTANTS.PAGE.MASTER_DATA.CHILDREN.COMPANY.PATH,
        pathMatch: 'full',
      },
    ],
  },
