...
export function GET_CONFIG_ADD_NEW_NHAN_SU() {
  ...
  return [
    {
      fieldName: USER_FIELD_CONSTANT.TEN_NHAN_VIEN,
    ...
    {
      fieldName: USER_FIELD_CONSTANT.CHUC_VU,
    ...
    {
      fieldName: USER_FIELD_CONSTANT.CONG_VIEC_HIEN_TAI,
      iComponent: SharedInputComponent,
    ...
    {
      fieldName: USER_FIELD_CONSTANT.THUOC_CONG_TY,
      iComponent: SharedSelect,
      label: 'Thuộc Công Ty',
      iParams: {
    ...
    {
      fieldName: USER_FIELD_CONSTANT.EMAIL_CA_NHAN,
      iComponent: SharedInputComponent,
      label: 'Email Cá Nhân',
      iParams: {},
      className: 'col-6',
    ...
    {
      fieldName: USER_FIELD_CONSTANT.DIEN_THOAI_CA_NHAN,
      iComponent: SharedInputComponent,
    ...
    {
      fieldName: USER_FIELD_CONSTANT.DIA_CHI_NHA_RIENG,
      iComponent: SharedInputComponent,
    ...
    {
      fieldName: USER_FIELD_CONSTANT.THANH_PHO,
      iComponent: SharedInputComponent,
      label: 'Thành Phố',
      iParams: {},
      className: 'col-12',
