...
export function GET_ADD_NEW_ACTIVITIES() {
  ...
  return [
    {
      fieldName: FIELD_THEO_DOI_HOAT_DONG_CONSTANTS.REGISTRATION_ID,
    ...
    {
      fieldName: FIELD_THEO_DOI_HOAT_DONG_CONSTANTS.THOI_GIAN_VAO_CONG,
    ...
    {
      fieldName: FIELD_THEO_DOI_HOAT_DONG_CONSTANTS.GIO_VAO_CONG,
    ...
    {
      fieldName: FIELD_THEO_DOI_HOAT_DONG_CONSTANTS.THOI_GIAN_CAN_LAN_1,
      iComponent: SharedTimePicker,
    ...
    {
      fieldName: FIELD_THEO_DOI_HOAT_DONG_CONSTANTS.VI_TRI_CAN_LAN_1,
    ...
    {
      fieldName: FIELD_THEO_DOI_HOAT_DONG_CONSTANTS.KHOI_LUONG1,
      iComponent: SharedInputComponent,
    ...
    {
      fieldName: FIELD_THEO_DOI_HOAT_DONG_CONSTANTS.THOI_GIAN_CAN_LAN_2,
      iComponent: SharedTimePicker,
    ...
    {
      fieldName: FIELD_THEO_DOI_HOAT_DONG_CONSTANTS.VI_TRI_CAN_LAN_2,
      iComponent: SharedInputComponent,
    ...
    {
      fieldName: FIELD_THEO_DOI_HOAT_DONG_CONSTANTS.KHOI_LUONG2,
      iComponent: SharedInputComponent,
    ...
    {
      fieldName: FIELD_THEO_DOI_HOAT_DONG_CONSTANTS.THOI_GIAN_RA_CONG,
      iComponent: SharedDatePicker,
      label: 'Ngày Ra Cổng',
      iParams: {},
      className: 'col-6',
    ...
    {
      fieldName: FIELD_THEO_DOI_HOAT_DONG_CONSTANTS.GIO_RA_CONG,
      iComponent: SharedTimePicker,
    ...
    {
      fieldName: FIELD_THEO_DOI_HOAT_DONG_CONSTANTS.TRONG_LUONG_HANG,
      iComponent: SharedInputComponent,
