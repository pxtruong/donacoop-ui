...
export class CoreSideNav extends BasicExtends {
  ...
  public navList: ISideNavItem[] = [
    {
      isDisabled: false,
      link: `/${ROUTE_CONSTANTS.QUARRY.MASTER_DATA.FULL_PATH}`,
      label: 'Dữ Liệu Chính',
      icon: 'sticky_note_2',
      ...
      children: [
        {
          isDisabled: false,
          link: `/${ROUTE_CONSTANTS.QUARRY.MASTER_DATA.CHILDREN.COMPANY.FULL_PATH}`,
          label: 'Công Ty',
          icon: 'apartment',
          customClass: 'icon-white',
        },
        {
          isDisabled: false,
          link: `/${ROUTE_CONSTANTS.QUARRY.MASTER_DATA.CHILDREN.USER.FULL_PATH}`,
          label: 'Nhân Sự',
        ...
        {
          isDisabled: false,
          link: `/${ROUTE_CONSTANTS.QUARRY.MASTER_DATA.CHILDREN.TRUCKS.FULL_PATH}`,
        ...
        {
          isDisabled: false,
          link: `/${ROUTE_CONSTANTS.QUARRY.MASTER_DATA.CHILDREN.MACHINERIES.FULL_PATH}`,
          label: 'Xe Công Trình',
        ...
        {
          isDisabled: false,
          link: `/${ROUTE_CONSTANTS.QUARRY.MASTER_DATA.CHILDREN.WAREHOUSES.FULL_PATH}`,
          label: 'Kho',
          icon: 'store',
          customClass: 'icon-white',
        },
        {
          isDisabled: false,
          link: `/${ROUTE_CONSTANTS.QUARRY.MASTER_DATA.CHILDREN.STONE_TYPE.FULL_PATH}`,
          label: 'Loại Đá',
          icon: 'dns',
          customClass: 'icon-white',
        },
        {
          isDisabled: false,
          link: `/${ROUTE_CONSTANTS.QUARRY.MASTER_DATA.CHILDREN.POSITION.FULL_PATH}`,
          label: 'Chức Vụ',
          icon: 'assignment_ind',
          customClass: 'icon-white',
        },
    ...
    {
      isDisabled: false,
      link: `/${ROUTE_CONSTANTS.QUARRY.REGISTRATION_AND_ACTIVITIES.FULL_PATH}`,
    ...
    {
      isDisabled: false,
      link: `/${ROUTE_CONSTANTS.QUARRY.KE_HOACH.FULL_PATH}`,
      label: 'Kế Hoạch',
      icon: 'assignment',
      customClass: 'icon-white',
    },
    {
      isDisabled: false,
      link: `/${ROUTE_CONSTANTS.QUARRY.SIMULATOR.FULL_PATH}`,
